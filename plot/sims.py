...
# --- 2. 准备新数据 ---
data = {
    'Model': ['EL_LSTM', 'LF_DNN', 'TFN', 'LMF', 'MFN', 'MulT', 'Self-MM', 'MOE-AHL'],
    'Acc-5': [21.23, 39.74, 39.30, 40.53, 39.47, 37.94, 41.53, 48.14],
    'Acc-3': [54.27, 64.33, 65.12, 64.68, 65.73, 64.77, 65.47, 66.95],
    'Acc-2': [69.37, 77.02, 78.38, 77.77, 77.9, 78.56, 80.04, 81.40],
    'F1': [56.82, 77.27, 78.62, 77.88, 77.88, 79.66, 80.44, 81.41],
    'Corr': [0.545, 0.555, 0.591, 0.575, 0.582, 0.564, 0.595, 0.593]
}
