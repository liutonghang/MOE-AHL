...
data = {
    ...
    'Acc-7': [50.01, 50.83, 51.6, 51.59, 51.34, 52.84, 52.05, 53.87, 54.73],
    'Acc-5': [51.16, 51.97, 53.1, 52.99, 52.76, 54.18, 53.63, 55.53, 56.45],
    'Acc-2': [80.79, 82.74, 81.89, 83.48, 82.86, 84.63, 84.67, 85.15, 86.32],
    'F1': [80.67, 82.52, 81.74, 83.36, 82.85, 84.52, 84.66, 84.90, 86.13],
    'Corr': [0.682, 0.708, 0.714, 0.716, 0.718, 0.733, 0.751, 0.764, 0.775]
}
...
# 4. 绘制 Corr (使用右侧 Y 轴，因为它的量级在 0-1 之间)
ax2 = ax1.twinx()
...
ax2.set_ylim(0.6, 0.85) # 优化相关系数的展示范围
